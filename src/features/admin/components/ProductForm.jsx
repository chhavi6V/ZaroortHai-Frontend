...
function ProductForm() {
  ...
  const warrantyInformation = useSelector(selectWarranty);
  ...
  useEffect(() => {
    if (selectedProduct && params.id) {
      ...
      setValue("availability", selectedProduct.availability);
      setValue("category", selectedProduct.category);
      setValue("warranty", selectedProduct.warrantyInformation);
    }
              ...
              <div className="mt-2">
                ...
                >
                  ...
                  {warrantyInformation.map((warranty) => (
                    <option value={warranty.value}>{warranty.label}</option>
                  ))}
                </select>
                {errors.warranty && (
